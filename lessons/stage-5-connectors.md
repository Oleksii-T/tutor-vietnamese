...
- Most conjunctions follow English word order between the two clauses
- **Nếu** (if) always begins the conditional clause
- **Nên** means both "so" (consequence) and "should"
- **Sau đó** always connects two complete clauses
- **Cũng** (also/too) comes before the verb: "Tôi cũng đi"
- **Vì** starts the reason clause; **nên** starts the result clause
