...
- Time expressions can appear at the **start or end** of a sentence
- **Vào** = "on" for days/months: "Vào thứ Hai" (on Monday)
- Time of day: [number] + **giờ** → "ba giờ" (3 o'clock)
- For 15 = mười lăm ("lăm" replaces "năm" after tens)
- Days: Thứ Hai through Thứ Bảy (Mon–Sat), Chủ Nhật (Sunday)
