...
- **Đã** = past: "Tôi đã ăn" (I already ate)
- **Đang** = present continuous: "Tôi đang ăn" (I am eating)
- **Sẽ** = future: "Tôi sẽ ăn" (I will eat)
- **Rồi** at end strengthens past completion: "Tôi đã ăn rồi"
- Without a marker, context determines time. Markers add precision.
